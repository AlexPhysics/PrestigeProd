  ...
  const swissStandards = [
    {
      ...
      description: t('swissStandards.quality.desc', 'Cinema-grade equipment for crystal clear results')
    },
    {
      metric: "Fast",
      label: t('swissStandards.delivery.label', 'Efficient Process'),
      description: t('swissStandards.delivery.desc', 'Quick delivery without ever compromising quality')
    },
    {
      metric: new Date().getFullYear().toString(),
      label: t('swissStandards.projects.label', 'Social Media Era'),
      description: t('swissStandards.projects.desc', 'Creating content that stands out in the digital noise')
    }
  ];
    ...
    <section className='py-20 bg-gradient-to-b from-black via-zinc-900 to-black relative overflow-hidden'>
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-6'>
        ...
        <div className='text-center mb-20'>
          ...
          >
            High-quality visual content that showcases your business professionally and drives results.
          </motion.p>
        </div>
          ...
          {swissStandards.map((standard, index) => (
            ...
            >
              ...
              <div className='relative p-8'>
                ...
                <h3 className='text-xl md:text-2xl font-medium text-white mb-4 tracking-wide'>{standard.label}</h3>
                <p className='text-white/70 leading-relaxed text-lg font-light max-w-xs mx-auto'>{standard.description}</p>
              </div>
            </motion.div>
          ))}
        </div>
          ...
          <div className='relative bg-gradient-to-br from-white/[0.12] via-white/[0.05] to-white/[0.12] backdrop-blur-xl rounded-3xl p-10 md:p-16 border border-white/20 shadow-2xl'>
            ...
            <div className='text-center mb-16'>
              ...
              >
                ...
                <span className='text-[#9EB6A9] font-medium tracking-wide'>Why Choose Us</span>
              </motion.div>
              ...
              <p className='text-xl md:text-2xl text-white/80 max-w-4xl mx-auto mb-12 leading-relaxed font-light'>
                We deliver high-quality visual content with Swiss precision and reliability.
              </p>
            </div>
                ...
                <div className='space-y-6'>
                  {[
                    ...
                    >
                      ...
                      <span className='text-white/70 text-lg font-light'>{item}</span>
                    </motion.div>
                  ))}
                </div>
              </div>
            ...
            >
              <div className='inline-flex items-center px-8 py-4 bg-gradient-to-r from-[#205C57]/20 to-[#9EB6A9]/20 border border-[#9EB6A9]/30 rounded-full backdrop-blur-sm'>
                <svg className='w-6 h-6 text-[#9EB6A9] mr-3' fill='currentColor' viewBox='0 0 20 20'>
