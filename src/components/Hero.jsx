    ...
    <section className='w-full min-h-screen relative overflow-hidden'>
      ...
      <div className='absolute inset-0'>
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to top, rgba(35, 31, 32, 0.8) 0%, transparent 50%, rgba(158, 182, 169, 0.05) 100%)',
          }}
        ></div>

        {/* Floating geometric elements with brand colors */}
        <div
          className='absolute top-1/4 right-1/5 w-px h-32 rotate-12 animate-pulse'
          style={{
        ...
        ></div>
        <div
          className='absolute bottom-1/3 left-1/6 w-24 h-px rotate-45 animate-pulse'
          style={{
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at center, transparent 40%, rgba(35, 31, 32, 0.6) 100%)',
          }}
        ></div>
      </div>
        ...
        <div id='hero-scroll' className='pb-12 flex justify-center opacity-0'>
          <div className='flex flex-col items-center space-y-2'>
            ...
            <div
              ...
              style={{ backgroundColor: 'rgba(158, 182, 169, 0.4)' }}
            ></div>
          </div>
        </div>
      </div>
